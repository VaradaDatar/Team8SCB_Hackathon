...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center">
            <h1 data-aos="fade-up">
            Supporting clients, colleagues and communities
      ...
      <section id="features" class="features">
        <div class="container" data-aos="fade-up">
          <header class="section-header">
            <h2>Features</h2>
            <p>Our new Investments system by women, for women </p>
          </header>
    ...
    <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>Standard Chartered</span></strong
          >. All Rights Reserved
        </div>
        <div class="credits">
